<?php
// طباعة كل ما تم إرساله للصفحة للتأكد من وجود البيانات
echo "<pre>";
print_r($_POST); // إذا كنت تستخدم طريقة POST
print_r($_GET);  // إذا كنت تستخدم طريقة GET
echo "</pre>";
die(); // إيقاف تنفيذ الكود هنا لرؤية البيانات فقط
// <?php
...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        // Pusher trigger failed - continue
    }
}
